    ...
    <div className='cont'>
        ...
        <div className="cont-container">
          ...
          <div className="cont-left">
            <div className="cont-title">Let me build for you</div>
          ...
          <div className="cont-right">
            <p className="cont-desc">
              <b>What's your name</b> Get in touch, I am always available for freelancing if the right project comes along me. 
            </p>
